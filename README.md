...
**Integral Curve Clustering and Simplification for Flow Visualization: A Comparative Evaluation**, by L. Shi, R. S. Laramee and G. Chen, IEEE Transactions on Visualization and Computer Graphics (to appear).
